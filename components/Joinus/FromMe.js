...
const FromMe = () => {
  return (
    <div className="bg-blue-400 overflow-hidden">
      <div
        className="max-w-screen-xl mt-8 mb-6 sm:mt-14 sm:mb-14 lg:my-24 px-6 sm:px-8 lg:px-16 mx-auto"
        id="feature"
      >
        <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8 py-8 my-12">
          <div className="flex w-full justify-end">
            <div className="h-full w-full p-4">
              <Image
                src="/assets/joinus/joinus-image-bottom.png"
                alt="VPN Illustrasi"
                layout="responsive"
                quality={100}
                height={400}
          ...
          <div className="flex flex-col justify-center ml-auto w-full lg:w-9/12">
            <h3 className="text-3xl lg:text-4xl font-medium leading-relaxed text-white-300">
              Our Goal
            </h3>
